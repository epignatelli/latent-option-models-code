    ...
    def __init__(self, cfg: LOMCfg, method: str = "", signal: str = "") -> None:
        ...
        try:
            ...
            run_cfg = {
                "method":               self.method,
                "signal":               self.signal,
                "data/dataset_dir":     d.dataset_dir,
                ...
                "model/dropout":           m.dropout,
                "model/vq_dropout":        m.vq_dropout,
                "model/predict_sequence":  m.predict_sequence,
                "train/max_iters":      t.max_iters,
                "train/batch_size":     t.batch_size,
                "train/lr":             t.lr,
                "train/weight_decay":   t.weight_decay,
                "train/eta_min":        t.eta_min,
                "train/warmup_iters":   t.warmup_iters,
                "train/grad_clip":      t.grad_clip,
                "train/compile_model":  t.compile_model,
                "train/ckpt_dir":       t.ckpt_dir,
                "train/seed":           t.seed,
